...
HD_PWD='/home/seba/documents/hepia/lora/pps_gen_fpga/PPS_generator/PPS_generator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pps_generator_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pps_generator_wrapper.tcl
