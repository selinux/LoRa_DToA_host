...
HD_PWD='/home/seba/documents/hepia/lora/pps_gen_fpga/PPS_generator/PPS_generator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pps_generator_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pps_generator_wrapper.tcl -notrace
