...
HD_PWD='/home/seba/documents/hepia/lora.baki7/lora_host_work/counter_PPS/counter_PPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_counter_PPS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_counter_PPS_wrapper.tcl
