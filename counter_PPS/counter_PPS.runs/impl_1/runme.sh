...
HD_PWD='/home/seba/documents/hepia/lora.baki7/lora_host_work/counter_PPS/counter_PPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_counter_PPS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sync_counter_PPS_wrapper.tcl -notrace
