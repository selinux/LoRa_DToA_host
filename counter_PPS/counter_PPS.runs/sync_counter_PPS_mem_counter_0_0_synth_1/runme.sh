...
HD_PWD='/home/seba/documents/hepia/lora/counter_PPS/counter_PPS.runs/sync_counter_PPS_mem_counter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sync_counter_PPS_mem_counter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sync_counter_PPS_mem_counter_0_0.tcl
